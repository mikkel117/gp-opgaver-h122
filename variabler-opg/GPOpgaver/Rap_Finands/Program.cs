    ...
    class Program
    {
        ...
        static void dos_start()
        {
            ...
            while (blivVedogved)
            {
                ...
                /*ændre valg1 til valg så den bliver en int og converter readline fra string til int*/
                /*det gjore jeg fordi den ande gave 2 linjer kode og denne her giver kun 1*/
                /*den før sage også valg1 + 1 så hvis man sage 1 så pluse den det med 1 og det ville-*/
                /*blive 11*/
